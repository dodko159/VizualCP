    ...
    <div class="content">
        <div class="left_side">
            ...
            <div class="head_of_category">
                <h1 class="textShadow"><span class="hide-1200"><?php echo $head_category_titele_prefix; ?></span><span
                            class="show-1200 hide-780"><?php echo $head_category_titele_prefix_short; ?></span>
        ...
        <div class="under_door textShadow" id="under_door">
            ...
            <span id="under_door_desc"><?php if ($isWien) {
                    echo $framePriceDescWien;
                } else {
                    echo $framePriceDesc;
                } ?></span>
            <?php if ($enablePO) { ?>
                <div id="under_door_buttons">
                <span class="minimize" id="po_link_add" style="background-color: darkred">
                    <?php echo $addToCP; ?>
...
<!--</svg>-->
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                         class="bi bi-cart-plus" viewBox="0 0 16 16" style="margin-bottom: 5px">
...
<!--                </span>-->
        ...
        <div class="room_selection_container selection_container rtl">
            <div id="room_section_openclose_btn" class="section_openclose_btn">
                <div class="openclose_btn_text_area openclose_btn_text_area_move_right">
            ...
            <div class="selection_content ltr">
                <div class="doors_container categories container clearfix">
                    ...
                    foreach ($categories as $cat) {
                        ...
                        ?>
                        <div class="door">
                            <a href="./?category=<?php echo $cat['name']; ?>" <?php echo 'id="category_' . $cat['name'] . '"'; ?>
                               class="<?php if (removeAccents($category['name']) == $cat['name']): echo 'sel'; else: echo 'desel'; endif; ?>">
                                <div class="door_img">
                        ...
                        for ($j = 7; $j > 1; $j--) {
                            if ($i % $j == 0) {
                                echo '<div class="show' . $j . 'only clearfix"></div>';
                            }
                        }
                        $i++;
                    }
                ...
                <div class="rooms_container container clearfix">
                    ...
                    foreach ($rooms as $image) {
                        ...
                        ?>
                        <div class="room">
                            <a href="javascript:void(0);" <?php echo 'id="room_' . $i . '_' . $src . '"'; ?>
                               class="<?php if ($i == $r): echo 'sel'; else: echo 'desel'; endif;
                               $i++; ?>">
                                <div class="room_img">
                ...
                <div class="material_container container clearfix" id="floor_materials">
                    ...
                    <div class="item">
                        <a href="javascript:void(0);"
                           class="<?php if (1 == $f): echo 'sel'; else: echo 'desel'; endif; ?>" <?php echo 'id="floor_default"'; ?>>
                            <div class="material">
                    ...
                    foreach ($floors as $floor) {
                        ...
                        <div class="item">
                            <a href="javascript:void(0);"
                               class="<?php if ($i == $f): echo 'sel'; else: echo 'desel'; endif; ?>" <?php echo 'id="floor_' . $src . '"'; ?>>
                                <div class="material">
        ...
        <div class="door_selection_container selection_container">
            <div id="door_section_openclose_btn" class="section_openclose_btn">
                ...
                <div class="openclose_btn_text_area" id="openclose_btn_text_area_doors">
                    <span class="openclose_btn_text"><?php echo $zmenit_dvere; ?></span>
                </div>
                <div class="openclose_btn_text_area" id="openclose_btn_text_area_priceOffer">
                    <span class="openclose_btn_text">Cenová ponuka</span>
                </div>
            </div>
            <!-- dvere -->
                ...
                <div id="doors-container">
                    <div class="doors_container container clearfix" id="doors">
                        ...
                        foreach ($doors as $image) {
                            ?>
                            <div class="door">
                                <a href="javascript:void(0);" <?php echo 'id="door_' . $image . '"'; ?>
                                   class="<?php if ($i == $d): echo 'sel'; else: echo 'desel'; endif; ?>">
                                    <div class="door_img">
                    ...
                    <div class="material_container container clearfix" id="door_materials">
                        ...
                        foreach (array_keys($materials) as $material_type) {
                            ...
                            foreach ($materials[$material_type] as $material) {
                                ...
                                <div class="item">
                                    <a href="javascript:void(0);"
                                       class="<?php if ($i == $m && $k == 1): echo 'sel'; else: echo 'desel'; endif; ?>" <?php echo 'id="material_' . $src . '"'; ?>>
                                        <div class="material">
                    ...
                    if ($isWien) {
                        ...
                        <div class="material_container container clearfix" id="handle_types">
                            ...
                            foreach ($handles as $handle) {
                                ...
                                <div class="item">
                                    <a href="javascript:void(0);"
                                       class="<?php if ($i == $h): echo 'sel'; else: echo 'desel'; endif; ?>" <?php echo 'id="handle_' . $src . '"'; ?>>
                                        <div class="material">
                    ...
                    <div class="material_container container clearfix" id="glass_types">
                        ...
                        foreach ($glasses as $glass) {
                            ...
                            ?>
                            <div class="item">
                                <a class="material" <?php echo 'href="' . $glass_path . '/' . $src . '.jpg"'; ?>
                                   data-fancybox="gallery" title="<?php echo $glass; ?>">
                                    <img <?php echo 'src="' . $glass_path . '/min/' . $src . '.jpg"'; ?>
                                            class="material_img">
                                </a>
